...
export default function Class1() {
  ...
  const fetchStudents = async () => {
    ...
    const studentsList = snapshot.docs
      ...
      .filter(student => student.studentClass === "3-1" || student.studentClass === "3-2");
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.pageTitle}>Students of Class 3</Text>
      <Text style={styles.subtitle}>(3-1 & 3-2)</Text>
      <FlatList
        data={students}
