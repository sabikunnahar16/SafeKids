...
export default function Class1() {
  ...
  const fetchStudents = async () => {
    ...
    const studentsList = snapshot.docs
      ...
      .filter(student => student.studentClass === "7-1" || student.studentClass === "7-2");
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.pageTitle}>Students of Class 7</Text>
      <Text style={styles.subtitle}>(7-1 & 7-2)</Text>
      <FlatList
        data={students}
