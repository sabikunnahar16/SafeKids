...
export default function Class1() {
  ...
  const fetchStudents = async () => {
    ...
    const studentsList = snapshot.docs
      ...
      .filter(student => student.studentClass === "10-1" || student.studentClass === "10-2");
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.pageTitle}>Students of Class 10</Text>
      <Text style={styles.subtitle}>(10-1 & 10-2)</Text>
      <FlatList
        data={students}
