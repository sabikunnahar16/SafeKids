...
export default function Class1() {
  ...
  const fetchStudents = async () => {
    ...
    const studentsList = snapshot.docs
      ...
      .filter(student => student.studentClass === "8-1" || student.studentClass === "8-2");
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.pageTitle}>Students of Class 8</Text>
      <Text style={styles.subtitle}>(8-1 & 8-2)</Text>
      <FlatList
        data={students}
