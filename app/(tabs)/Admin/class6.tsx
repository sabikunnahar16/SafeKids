...
export default function Class1() {
  ...
  const fetchStudents = async () => {
    ...
    const studentsList = snapshot.docs
      ...
      .filter(student => student.studentClass === "6-1" || student.studentClass === "6-2");
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.pageTitle}>Students of Class 6</Text>
      <Text style={styles.subtitle}>(6-1 & 6-2)</Text>
      <FlatList
        data={students}
